  ...
  switch (keycode) {
    case QMKPWD:
      if (record->event.pressed) {
        // when keycode QMKPWD is pressed
        SEND_STRING("shityounot");
      } else {
        // when keycode QMKPWD is released
      }
      break;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	/* 0: BASE */
	[0] = LAYOUT(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  KC_INSERT,  KC_HOME,
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   MO(2),    KC_SPC,                       KC_RALT,  MO(1),    KC_RCTL,  KC_LEFT,  KC_DOWN,    KC_RGHT
	),
    ...
    [2] = LAYOUT(
		...
		_______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______,  _______,
		_______,  QMKPWD,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
		_______,  _______,  _______,                      _______,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,  _______
	),
};
